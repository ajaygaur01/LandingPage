          ...
          <div className="col-lg-12">
            <div className="service-all-boxes-area">
              ...
              >
                ...
                <img
                  src="/assets/img/icons/service-icon1.svg"
                  alt="SEO Service"
                />
                <div className="space40"></div>
                <p>
              ...
              >
                ...
                <div className="space40"></div>
                <img
                  src="/assets/img/icons/service-icon2.svg"
                  alt="PPC Service"
                />
                <div className="space40"></div>
                <p>
              ...
              >
                ...
                <img
                  src="/assets/img/icons/service-icon3.svg"
              ...
              >
                ...
                <div className="space40"></div>
                <img
                  src="/assets/img/icons/service-icon4.svg"
